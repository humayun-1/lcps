...
const Card = ({ data, url }) => {
    ...
    return (
        <div className="max-w-sm rounded-lg overflow-hidden shadow-md cursor-pointer" onClick={() => navigate(url ? url : `/student/course-details/${data?.id}`)} >
            ...
            <div className='border rounded-b-lg'>
                <div className="px-4 py-4 bg-white">
                    <div className='flex items-center gap-3 justify-between text-[#6D6D6D] text-xs'>
                        ...
                        <p>Hours: {data ? `${data?.hours}` : "10h 58m"}</p>
                    </div>
