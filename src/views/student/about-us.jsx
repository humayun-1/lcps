...
const AboutUs = () => {
    return (
        <StudentContainer>
            <div className='container py-[4rem] grid md:grid-cols-2 grid-cols-1 gap-[3rem] lg:gap-[5rem]'>
                <div>
                ...
                <div>
                    <img src="https://source.unsplash.com/random?laptops" className='h-[20rem] object-cover w-full' alt="Sunset in the mountains" />
                </div>
